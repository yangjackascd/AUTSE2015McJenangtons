                ...
                if (!empty($paper_author)) {
                    if (!empty($paper_year)) {
                        if (!empty($paper_context)) {
                            ...
                            $sql_create_data = "INSERT INTO paper_table (paper_title, paper_name,author,year,paper_upload_date,username,status,paper_journal)VALUES('$paper_title','$paper_name','$paper_author','$paper_year','$date','$account',2,'$paper_journal')";
